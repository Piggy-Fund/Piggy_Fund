	...
	<div class="container">
		...
		<div class="row mb-1 " >
			<div class="col-md-12 shadow p-3 mb-5 bg-white rounded border-top border-right " >
				<div><h4 class="text-secondary font-weight-bold">净值估算</h4><p class="mb-1 text-muted">(20-12-15 15:00)</p></div>
				<hr>
			...
			<div class="col-md-12 shadow p-3 mb-5 bg-white rounded border-top border-right" >
				<div><h4 class="text-secondary font-weight-bold">增长率</h4><p class="mb-1 text-muted">(20-12-15 15:00)</p></div>
				<hr>
				<div class="row mb-2 ">
					<div class="col-md-6 ">
						<ul class="list-unstyled mt-3 mb-4">
			...
			<div class="col-md-12 shadow p-3 mb-5 bg-white rounded border-top border-right" >
				<div><h4 class="text-secondary font-weight-bold">其它</h4><p class="mb-1 text-muted">(20-12-15 15:00)</p></div>
				<hr>
				<div class="row mb-2 ">
					<div class="col-md-6 ">
						<ul class="list-unstyled mt-3 mb-4">
			...
			<div class="col-md-12 shadow p-3 mb-5 bg-white rounded border-top border-right" >
				<div><h4 class="text-secondary font-weight-bold">购买</h4><p class="mb-1 text-muted">(20-12-15 15:00)</p></div>
				<hr>
				<div class="row mb-2 ">
					<div class="col-md-6 ">
						<ul class="list-unstyled mt-3 mb-4">
							...
							<li class = "mb-sm-2">金额：<input class=" col-md-3" placeholder="输入金额"></li>
						</ul>
					</div>
					<div class="col-md-6 ">
						<ul class="list-unstyled mt-3 mb-4">
							<li><a class="btn btn-secondary  mr-sm-2 mb-sm-2" href="#">立即购买</a></li>
							<li><a class="btn btn-secondary  mr-sm-2 mb-sm-2" href="#">定投</a></li>
							<li><a class="btn btn-secondary  mr-sm-2" href="#">免费开户</a></li>
						</ul>
					</div>
				</div>
			</div>
