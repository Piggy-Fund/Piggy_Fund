		...
		<div class="container bg-light">
			...
			<div class="row">
				...
				<h4 class="mb-3 text-muted">账单信息</h4>
					...
					<form method ="get" action="SaleAction">
						<div class="row">
							<div class="col-md-6 mb-3">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								<label>拥有数量：${fundnum}份</label> 
								<label ><input type="radio" name="havenum" value="${fundnum}" checked style="display:none"/></label> 
							</div>
						</div>
						
						<div class="row">
							<div class="col-md-6 mb-3">
								<label >出售数量：</label> 	<p style="color:red">${error}</p>
							...
							<div class="col-md-6 mb-3">
								...
								<div class="col-md-6 mb-1">
									<label ><input type="radio" name="optradio1" value="all">全部出售</label> 
								</div>
							</div>
						</div>
	
						<hr class="mb-4">
						<button type="submit" class="btn btn-secondary btn-lg btn-block">确认</button>
					</form>
				</c:forEach>
				</div>
			</div>
